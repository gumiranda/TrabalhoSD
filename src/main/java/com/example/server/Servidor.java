        ...
        if (arquivo.exists()) {
            ...
            if(ultima!= null){
               ...
               new Servidor(porta).executa();
                ...
                System.out.println("Segundo servidor j· foi iniciado");
                porta = 8082;
               //out.println("");
               ...
               out.println("Port;"+porta);
                ...
                System.out.println("Terceiro servidor j· foi iniciado");
                porta = 8083;
               //out.println("");
               ...
               out.println("Port;"+porta);
                ...
                System.out.println("Quarto servidor j· foi iniciado");
                porta = 8084;
               //out.println("");
