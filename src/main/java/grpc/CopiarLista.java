    ...
    public void run() {
        while (true) {
            try {
                ...
                if (this.porta == 59043) {
                    if ((c.getChave().compareTo(new BigInteger("0")) == 1 || c.getChave().compareTo(new BigInteger("1")) == 1) && (c.getChave().compareTo(new BigInteger("300000")) == -1)) {
